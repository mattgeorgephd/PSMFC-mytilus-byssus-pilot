...
a1 <- read.delim("sequences/GCF_902806645.1_cgigas_uk_roslin_v1_feature_table.txt", header = TRUE)
...
mkdir DESEQ2_output/triploid_SS_diploid_control
mkdir DESEQ2_output/triploid_MS_diploid_control
...
# TRIPLOID SS, diploid control - compare to triploid:heat
```{r TRIPLOID:DESICCATION, warning=FALSE, include=TRUE}
...
# Filter data
coldata_trt <- coldata %>% filter(group == "A" | group == "D")
cts_trt     <- subset(cts, select=row.names(coldata_trt))
...
pdf(file= "DESEQ2_output/triploid_SS_diploid_control/MA_plots.pdf" )
par(mfrow=c(1,3), mar=c(4,4,2,1))
xlim <- c(1,1e5); ylim <- c(-3,3)
DESeq2::plotMA(res_table_normal, xlim=xlim, ylim=ylim, main="normal", cex=.8)
abline(h=c(-1.5,1.5), col="dodgerblue", lwd=2)
...
all_genes           <- left_join(res_table, LOCID_Roslin_gigas_gene_mito_table, by = "gene")
all_genes           <- all_genes %>% arrange(-log2FoldChange)
all_genes$treatment <- "triploid_SS_diploid_control"
# all_genes_pvalue    <- cbind(gene=all_genes$gene,padj=all_genes$padj)

all_genes_normal           <- left_join(res_table_normal, LOCID_Roslin_gigas_gene_mito_table, by = "gene")
all_genes_normal           <- all_genes_normal %>% arrange(-log2FoldChange)
all_genes_normal$treatment <- "triploid_SS_diploid_control"

all_genes_apeglm           <- left_join(res_table_apeglm, LOCID_Roslin_gigas_gene_mito_table, by = "gene")
all_genes_apeglm           <- all_genes_apeglm %>% arrange(-log2FoldChange)
# all_genes_apeglm           <- left_join(all_genes_apeglm, as.data.frame(all_genes_pvalue), by = "gene")
all_genes_apeglm$treatment <- "triploid_SS_diploid_control"

all_genes_ashr           <- left_join(res_table_ashr, LOCID_Roslin_gigas_gene_mito_table, by = "gene")
all_genes_ashr           <- all_genes_ashr %>% arrange(-log2FoldChange)
all_genes_ashr$treatment <- "triploid_SS_diploid_control"
...
sig_genes <- left_join(sig_genes, LOCID_Roslin_gigas_gene_mito_table, by = "gene")
sig_genes <- sig_genes %>% arrange(-log2FoldChange)
sig_genes$treatment <- "triploid_SS_diploid_control" 

sig_genes_normal <- res_table_normal %>%
  filter(abs(log2FoldChange) > lfc.cutoff)
sig_genes_normal <- left_join(sig_genes_normal, LOCID_Roslin_gigas_gene_mito_table, by = "gene")
sig_genes_normal <- sig_genes_normal %>% arrange(-log2FoldChange)
sig_genes_normal$treatment <- "triploid_SS_diploid_control" 

sig_genes_apeglm <- res_table_apeglm %>%
  filter(padj < padj.cutoff)
sig_genes_apeglm <- left_join(sig_genes_apeglm, LOCID_Roslin_gigas_gene_mito_table, by = "gene")
sig_genes_apeglm <- sig_genes_apeglm %>% arrange(-log2FoldChange)
sig_genes_apeglm$treatment <- "triploid_SS_diploid_control" 

sig_genes_ashr <- res_table_ashr %>%
  filter(padj < padj.cutoff)
sig_genes_ashr <- left_join(sig_genes_ashr, LOCID_Roslin_gigas_gene_mito_table, by = "gene")
sig_genes_ashr <- sig_genes_ashr %>% arrange(-log2FoldChange)
sig_genes_ashr$treatment <- "triploid_SS_diploid_control" 
...
write.table(single_gene_expression_unshrunk, file = "DESEQ2_output/triploid_SS_diploid_control/triploid_SS_diploid_control-unshrunk-single-gene-counts.csv", row.names = FALSE)
write.table(single_gene_expression_normal, file = "DESEQ2_output/triploid_SS_diploid_control/triploid_SS_diploid_control-normal-single-gene-counts.csv", row.names = FALSE)
write.table(single_gene_expression_apeglm, file = "DESEQ2_output/triploid_SS_diploid_control/triploid_SS_diploid_control-apeglm-single-gene-counts.csv", row.names = FALSE)
write.table(single_gene_expression_ashr, file = "DESEQ2_output/triploid_SS_diploid_control/triploid_SS_diploid_control-ashr-single-gene-counts.csv", row.names = FALSE)
...
# Output tables of DEGs
write.table(all_genes,        file = "DESEQ2_output/triploid_SS_diploid_control/triploid_SS_diploid_control-ALL-DEG.csv",            row.names = FALSE)
write.table(all_genes_normal, file = "DESEQ2_output/triploid_SS_diploid_control/triploid_SS_diploid_control-ALL-DEG-normal.csv",     row.names = FALSE)
write.table(all_genes_apeglm, file = "DESEQ2_output/triploid_SS_diploid_control/triploid_SS_diploid_control-ALL-DEG-apeglm.csv",     row.names = FALSE)
write.table(all_genes_ashr,   file = "DESEQ2_output/triploid_SS_diploid_control/triploid_SS_diploid_control-ALL-DEG-ashr.csv",       row.names = FALSE)
write.table(sig_genes,        file = "DESEQ2_output/triploid_SS_diploid_control/triploid_SS_diploid_control-SIG-DEG-unshrunken.csv", row.names = FALSE)
write.table(sig_genes_normal, file = "DESEQ2_output/triploid_SS_diploid_control/triploid_SS_diploid_control-SIG-DEG-normal.csv",     row.names = FALSE)
write.table(sig_genes_apeglm, file = "DESEQ2_output/triploid_SS_diploid_control/triploid_SS_diploid_control-SIG-DEG-apeglm.csv",     row.names = FALSE)
write.table(sig_genes_ashr,   file = "DESEQ2_output/triploid_SS_diploid_control/triploid_SS_diploid_control-SIG-DEG-ashr.csv",       row.names = FALSE)
write.table(gene_counts,      file = "DESEQ2_output/triploid_SS_diploid_control/triploid_SS_diploid_control-gene-counts.csv",        row.names = TRUE)
...
setwd("DESEQ2_output/triploid_SS_diploid_control")

ggexport(filename = "triploid_SS_diploid_control-BIPLOT.png",
         plot   = bp0,
         res    = 600,
         width  = 4000,
         height = 5000)

ggexport(filename = "triploid_SS_diploid_control-PCA.png",
         plot   = bp1,
         res    = 600,
         width  = 4000,
         height = 5000)

ggexport(filename = "triploid_SS_diploid_control-PAIRS.png",
         plot   = bp2,
         res    = 600,
         width  = 6000,
         height = 6000)

ggexport(filename = "triploid_SS_diploid_control-pheatmap.png",
         plot   = bp3,
         res    = 600,
         width  = 6000,
         height = 6000)
...
# Plot heatmap + annotations of top X number of DEGs (w/ lfc and pvalue cutoff)
png(filename = "DESEQ2_output/triploid_SS_diploid_control/triploid_SS_diploid_control_gene_heatmap.png", 
    res = 600, width = 6000, height = 4000, units = "px", pointsize = 6)
# Z-score matrix
h1 <- Heatmap(mat.scaled[rows_keep,], 
            column_labels       = colnames(mat.scaled),
...
```{r}
# Plot heatmap
png(filename = "DESEQ2_output/triploid_SS_diploid_control/triploid_SS_diploid_control_heatmap_pval_genes_apeglm.png", 
    res = 1200, width = 6000, height = 6000, units = "px", pointsize = 6)
# par(mar=c(5,8,4,1)+.1)
col <- colorRampPalette(brewer.pal(11, "RdYlBu"))(256)
heatmap(mat.scaled_sigs, scale = "none", col =  col, 
        ColSideColors = c(rep("royalblue1", 11), rep("red3", 10)))
dev.off()
...
# Save plots
ggsave("DESEQ2_output/triploid_SS_diploid_control/Volcano_all_genes.png",
       plot   = p1,
       dpi    = 600,
       device = "png",
       width  = 4,
...
ggsave("DESEQ2_output/triploid_SS_diploid_control/Volcano_all_genes_normal.png",
       plot   = p2,
       dpi    = 600,
       device = "png",
       width  = 4,
...
ggsave("DESEQ2_output/triploid_SS_diploid_control/Volcano_all_genes_ashr.png",
       plot   = p3,
       dpi    = 600,
       device = "png",
       width  = 4,
...
ggsave("DESEQ2_output/triploid_SS_diploid_control/Volcano_all_genes_apeglm.png",
       plot   = p4,
       dpi    = 600,
       device = "png",
       width  = 4,
...
ggsave("DESEQ2_output/triploid_SS_diploid_control/Volcano_pval_lfc_genes.png",
       plot   = p5,
       dpi    = 600,
       device = "png",
       width  = 4,
...
ggsave("DESEQ2_output/triploid_SS_diploid_control/Volcano_pval_lfc_genes_normal.png",
       plot   = p6,
       dpi    = 600,
       device = "png",
       width  = 4,
...
ggsave("DESEQ2_output/triploid_SS_diploid_control/Volcano_pval_lfc_genes_ashr.png",
       plot   = p7,
       dpi    = 600,
       device = "png",
       width  = 4,
...
ggsave("DESEQ2_output/triploid_SS_diploid_control/Volcano_pval_lfc_genes_apeglm.png",
       plot   = p8,
       dpi    = 600,
       device = "png",
       width  = 4,
...
# Output tables of DEGs
sigs$analysis <- "triploid_SS_diploid_control"
sigs_pval_lfc$analysis <- "triploid_SS_diploid_control"
write.table(sigs, file = "DESEQ2_output/triploid_SS_diploid_control/triploid_SS_diploid_control-sig-genes-apeglm-pval-only.csv", row.names = F)
write.table(sigs_pval_lfc, file = "DESEQ2_output/triploid_SS_diploid_control/triploid_SS_diploid_control-sig-genes-apeglm-pval-lfc.csv", row.names = F)

# Save plots
ggsave("DESEQ2_output/triploid_SS_diploid_control/triploid_SS_diploid_control_DEG_uncharacterized_pval_apeglm.png",
       plot   = bp4, bg = "transparent",
       dpi    = 1500,
       device = "png",
       width  = 4,
...
ggsave("DESEQ2_output/triploid_SS_diploid_control/triploid_SS_diploid_control-DEG-apeglm-updown-pie.png",
       plot   = bp5,
       dpi    = 600,
       device = "png",
       width  = 4,
...
ggsave("DESEQ2_output/triploid_SS_diploid_control/triploid_SS_diploid_control-DEG-apeglm-updown-bar.png",
       plot   = bp6,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("DESEQ2_output/triploid_SS_diploid_control/triploid_SS_diploid_control-DEG-apeglm.png",
       plot   = bp7,
       dpi    = 600,
       device = "png",
       width  = 5,
...
ggsave("DESEQ2_output/triploid_SS_diploid_control/triploid_SS_diploid_control-volcano_pval_genes_apeglm.png",
       plot   = p9,
       dpi    = 600,
       device = "png",
       width  = 4,
...
# TRIPLOID MS, diploid control - compare to triploid:desiccation
```{r TRIPLOID:DESICCATION, warning=FALSE, include=TRUE}
...
# Filter data
coldata_trt <- coldata %>% filter(group == "A" | group == "F")
cts_trt     <- subset(cts, select=row.names(coldata_trt))
...
pdf(file= "DESEQ2_output/triploid_MS_diploid_control/MA_plots.pdf" )
par(mfrow=c(1,3), mar=c(4,4,2,1))
xlim <- c(1,1e5); ylim <- c(-3,3)
DESeq2::plotMA(res_table_normal, xlim=xlim, ylim=ylim, main="normal", cex=.8)
abline(h=c(-1.5,1.5), col="dodgerblue", lwd=2)
...
all_genes           <- left_join(res_table, LOCID_Roslin_gigas_gene_mito_table, by = "gene")
all_genes           <- all_genes %>% arrange(-log2FoldChange)
all_genes$treatment <- "triploid_MS_diploid_control"
# all_genes_pvalue    <- cbind(gene=all_genes$gene,padj=all_genes$padj)

all_genes_normal           <- left_join(res_table_normal, LOCID_Roslin_gigas_gene_mito_table, by = "gene")
all_genes_normal           <- all_genes_normal %>% arrange(-log2FoldChange)
all_genes_normal$treatment <- "triploid_MS_diploid_control"

all_genes_apeglm           <- left_join(res_table_apeglm, LOCID_Roslin_gigas_gene_mito_table, by = "gene")
all_genes_apeglm           <- all_genes_apeglm %>% arrange(-log2FoldChange)
# all_genes_apeglm           <- left_join(all_genes_apeglm, as.data.frame(all_genes_pvalue), by = "gene")
all_genes_apeglm$treatment <- "triploid_MS_diploid_control"

all_genes_ashr           <- left_join(res_table_ashr, LOCID_Roslin_gigas_gene_mito_table, by = "gene")
all_genes_ashr           <- all_genes_ashr %>% arrange(-log2FoldChange)
all_genes_ashr$treatment <- "triploid_MS_diploid_control"
...
sig_genes <- left_join(sig_genes, LOCID_Roslin_gigas_gene_mito_table, by = "gene")
sig_genes <- sig_genes %>% arrange(-log2FoldChange)
sig_genes$treatment <- "triploid_MS_diploid_control" 

sig_genes_normal <- res_table_normal %>%
  filter(abs(log2FoldChange) > lfc.cutoff)
sig_genes_normal <- left_join(sig_genes_normal, LOCID_Roslin_gigas_gene_mito_table, by = "gene")
sig_genes_normal <- sig_genes_normal %>% arrange(-log2FoldChange)
sig_genes_normal$treatment <- "triploid_MS_diploid_control" 

sig_genes_apeglm <- res_table_apeglm %>%
  filter(padj < padj.cutoff)
sig_genes_apeglm <- left_join(sig_genes_apeglm, LOCID_Roslin_gigas_gene_mito_table, by = "gene")
sig_genes_apeglm <- sig_genes_apeglm %>% arrange(-log2FoldChange)
sig_genes_apeglm$treatment <- "triploid_MS_diploid_control" 

sig_genes_ashr <- res_table_ashr %>%
  filter(padj < padj.cutoff)
sig_genes_ashr <- left_join(sig_genes_ashr, LOCID_Roslin_gigas_gene_mito_table, by = "gene")
sig_genes_ashr <- sig_genes_ashr %>% arrange(-log2FoldChange)
sig_genes_ashr$treatment <- "triploid_MS_diploid_control" 
...
write.table(single_gene_expression_unshrunk, file = "DESEQ2_output/triploid_MS_diploid_control/triploid_MS_diploid_control-unshrunk-single-gene-counts.csv", row.names = FALSE)
write.table(single_gene_expression_normal, file = "DESEQ2_output/triploid_MS_diploid_control/triploid_MS_diploid_control-normal-single-gene-counts.csv", row.names = FALSE)
write.table(single_gene_expression_apeglm, file = "DESEQ2_output/triploid_MS_diploid_control/triploid_MS_diploid_control-apeglm-single-gene-counts.csv", row.names = FALSE)
write.table(single_gene_expression_ashr, file = "DESEQ2_output/triploid_MS_diploid_control/triploid_MS_diploid_control-ashr-single-gene-counts.csv", row.names = FALSE)
...
# Output tables of DEGs
write.table(all_genes,        file = "DESEQ2_output/triploid_MS_diploid_control/triploid_MS_diploid_control-ALL-DEG.csv",            row.names = FALSE)
write.table(all_genes_normal, file = "DESEQ2_output/triploid_MS_diploid_control/triploid_MS_diploid_control-ALL-DEG-normal.csv",     row.names = FALSE)
write.table(all_genes_apeglm, file = "DESEQ2_output/triploid_MS_diploid_control/triploid_MS_diploid_control-ALL-DEG-apeglm.csv",     row.names = FALSE)
write.table(all_genes_ashr,   file = "DESEQ2_output/triploid_MS_diploid_control/triploid_MS_diploid_control-ALL-DEG-ashr.csv",       row.names = FALSE)
write.table(sig_genes,        file = "DESEQ2_output/triploid_MS_diploid_control/triploid_MS_diploid_control-SIG-DEG-unshrunken.csv", row.names = FALSE)
write.table(sig_genes_normal, file = "DESEQ2_output/triploid_MS_diploid_control/triploid_MS_diploid_control-SIG-DEG-normal.csv",     row.names = FALSE)
write.table(sig_genes_apeglm, file = "DESEQ2_output/triploid_MS_diploid_control/triploid_MS_diploid_control-SIG-DEG-apeglm.csv",     row.names = FALSE)
write.table(sig_genes_ashr,   file = "DESEQ2_output/triploid_MS_diploid_control/triploid_MS_diploid_control-SIG-DEG-ashr.csv",       row.names = FALSE)
write.table(gene_counts,      file = "DESEQ2_output/triploid_MS_diploid_control/triploid_MS_diploid_control-gene-counts.csv",        row.names = TRUE)
...
setwd("DESEQ2_output/triploid_MS_diploid_control")

ggexport(filename = "triploid_MS_diploid_control-BIPLOT.png",
         plot   = bp0,
         res    = 600,
         width  = 4000,
         height = 5000)

ggexport(filename = "triploid_MS_diploid_control-PCA.png",
         plot   = bp1,
         res    = 600,
         width  = 4000,
         height = 5000)

ggexport(filename = "triploid_MS_diploid_control-PAIRS.png",
         plot   = bp2,
         res    = 600,
         width  = 6000,
         height = 6000)

ggexport(filename = "triploid_MS_diploid_control-pheatmap.png",
         plot   = bp3,
         res    = 600,
         width  = 6000,
         height = 6000)
...
# Plot heatmap + annotations of top X number of DEGs (w/ lfc and pvalue cutoff)
png(filename = "DESEQ2_output/triploid_MS_diploid_control/triploid_MS_diploid_control_gene_heatmap.png", 
    res = 600, width = 6000, height = 4000, units = "px", pointsize = 6)
# Z-score matrix
h1 <- Heatmap(mat.scaled[rows_keep,], 
            column_labels       = colnames(mat.scaled),
...
# Plot heatmap
png(filename = "DESEQ2_output/triploid_MS_diploid_control/triploid_MS_diploid_control_heatmap_pval_genes_apeglm.png", 
    res = 1200, width = 6000, height = 6000, units = "px", pointsize = 6)
# par(mar=c(5,8,4,1)+.1)
col <- colorRampPalette(brewer.pal(11, "RdYlBu"))(256)
heatmap(mat.scaled_sigs, scale = "none", col =  col, 
...
# Save plots
ggsave("DESEQ2_output/triploid_MS_diploid_control/Volcano_all_genes.png",
       plot   = p1,
       dpi    = 600,
       device = "png",
       width  = 4,
...
ggsave("DESEQ2_output/triploid_MS_diploid_control/Volcano_all_genes_normal.png",
       plot   = p2,
       dpi    = 600,
       device = "png",
       width  = 4,
...
ggsave("DESEQ2_output/triploid_MS_diploid_control/Volcano_all_genes_ashr.png",
       plot   = p3,
       dpi    = 600,
       device = "png",
       width  = 4,
...
ggsave("DESEQ2_output/triploid_MS_diploid_control/Volcano_all_genes_apeglm.png",
       plot   = p4,
       dpi    = 600,
       device = "png",
       width  = 4,
...
ggsave("DESEQ2_output/triploid_MS_diploid_control/Volcano_pval_lfc_genes.png",
       plot   = p5,
       dpi    = 600,
       device = "png",
       width  = 4,
...
ggsave("DESEQ2_output/triploid_MS_diploid_control/Volcano_pval_lfc_genes_normal.png",
       plot   = p6,
       dpi    = 600,
       device = "png",
       width  = 4,
...
ggsave("DESEQ2_output/triploid_MS_diploid_control/Volcano_pval_lfc_genes_ashr.png",
       plot   = p7,
       dpi    = 600,
       device = "png",
       width  = 4,
...
ggsave("DESEQ2_output/triploid_MS_diploid_control/Volcano_pval_lfc_genes_apeglm.png",
       plot   = p8,
       dpi    = 600,
       device = "png",
       width  = 4,
...
# Output tables of DEGs
sigs$analysis <- "triploid_MS_diploid_control"
sigs_pval_lfc$analysis <- "triploid_MS_diploid_control"
write.table(sigs, file = "DESEQ2_output/triploid_MS_diploid_control/triploid_MS_diploid_control-sig-genes-apeglm-pval-only.csv", row.names = F)
write.table(sigs_pval_lfc, file = "DESEQ2_output/triploid_MS_diploid_control/triploid_MS_diploid_control-sig-genes-apeglm-pval-lfc.csv", row.names = F)

# Save plots
ggsave("DESEQ2_output/triploid_MS_diploid_control/triploid_MS_diploid_control_DEG_uncharacterized_pval_apeglm.png",
       plot   = bp4, bg = "transparent",
       dpi    = 1500,
       device = "png",
       width  = 4,
...
ggsave("DESEQ2_output/triploid_MS_diploid_control/triploid_MS_diploid_control-DEG-apeglm-updown-pie.png",
       plot   = bp5,
       dpi    = 600,
       device = "png",
       width  = 4,
...
ggsave("DESEQ2_output/triploid_MS_diploid_control/triploid_MS_diploid_control-DEG-apeglm-updown-bar.png",
       plot   = bp6,
       dpi    = 600,
       device = "png",
       width  = 6,
...
ggsave("DESEQ2_output/triploid_MS_diploid_control/triploid_MS_diploid_control-DEG-apeglm.png",
       plot   = bp7,
       dpi    = 600,
       device = "png",
       width  = 5,
...
ggsave("DESEQ2_output/triploid_MS_diploid_control/triploid_MS_diploid_control-volcano_pval_genes_apeglm.png",
       plot   = p9,
       dpi    = 600,
       device = "png",
       width  = 4,
