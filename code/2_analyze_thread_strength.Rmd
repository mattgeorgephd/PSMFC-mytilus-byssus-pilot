...
# average across thread for each mussel * treatment combination
...
# Create a new dataframe called "thread_plot_OA_mean" using the "group_by" and "summarize" functions in "dplyr"
...
# Create a new dataframe called "thread_plot_OW_mean" using the "group_by" and "summarize" functions in "dplyr"
...
# Create a new dataframe called "thread_plot_DO_mean" using the "group_by" and "summarize" functions in "dplyr"
...
```{R}
# Define dataset for analysis, factors
dat_stat <- thread_plot_OA_repeated
test_me  <- dat_stat$adhesion_kpa
...
# Run repeated measures anova using oyster ID has random effect
# https://www.r-bloggers.com/2015/08/two-way-anova-with-repeated-measures/
my_test <- aov(response ~ trt +
                       Error(ID/trt), # Error(1|(factor(ID)/factor(trt))),
                       data = dat_stat)
...
```{R}
# Define dataset for analysis, factors
dat_stat <- thread_plot_OW_repeated
test_me  <- dat_stat$adhesion_kpa
