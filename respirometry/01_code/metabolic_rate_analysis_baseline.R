...
meas_dir <- here::here("02_data", "measurements", "20211026_T0")
...
constr_file <- file.path(constr_dir, "constraints_20211026_T0.xlsx")
if (!file.exists(constr_file)) {
  write.xlsx(x = dat_nested$ID_sort, file = constr_file, sheetName = "20211026_T0",
...
qc_dir <- here::here("03_analyses", "metabolic-rate", "QC_plots", "20211026_T0")
...
constraints <- read_excel(here::here("02_data", "constraints", "constraints_20211026_T0.xlsx"),
                          sheet = "20211026_T0", col_names = TRUE)
...
# NOTE: filename "SMR_slope_heat_only_T5" is a leftover from other code; consider
# renaming to match this timepoint, e.g. "SMR_slope_20211026_T0".
write.xlsx(x = oxy_hr, file = file.path(out_dir, "SMR_slope_heat_only_T5.xlsx"),
           sheetName = "heat_only_T5", col.names = TRUE, row.names = TRUE, append = FALSE)
