...
FDO_DAVID <- read_excel(file.path(func_david, "FDO_DAVID_chart.xlsx"))
...
# Load your data (adjust the path and function based on file type)
GDO_DAVID <- read_excel(file.path(func_david, "GDO_DAVID_chart.xlsx"))
...
# Load your data (adjust the path and function based on file type)
FOA_DAVID <- read_excel(file.path(func_david, "FOA_DAVID_chart.xlsx"))
...
# Load your data (adjust the path and function based on file type)
GOA_DAVID <- read_excel(file.path(func_david, "GOA_DAVID_chart.xlsx"))
...
# Load your data (adjust the path and function based on file type)
FOW_DAVID <- read_excel(file.path(func_david, "FOW_DAVID_chart.xlsx"))
...
# Load your data (adjust the path and function based on file type)
GOW_DAVID <- read_excel(file.path(func_david, "GOW_DAVID_chart.xlsx"))
