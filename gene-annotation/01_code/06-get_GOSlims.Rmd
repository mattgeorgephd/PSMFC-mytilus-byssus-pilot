...
```{bash rm-spaces-from-GOs, eval=FALSE}
# Remove "hidden" spaces in GOs, but preserve tabs, using sed
awk -F"\t" '{print $2, "\t", $1}' \
${GOTERMS}/FDO_sigs_ID.csv \
| sed 's/ \+//g' \
> ${GOTERMS}/FDO_sigs_ID.csv

head ${GOTERMS}/FDO_sigs_ID.csv
```
...
mapped_df %>%
  ...
  write.table(file =file.path(deg, "goslims_genome/FDO_sigs_ID.tab"),
          row.names = FALSE,
          col.names = TRUE,
          quote = FALSE,
          sep = "\t"
...
goslims_per_gene_df %>%
  write.table(file =file.path(deg, "goslims_genome/FDO_sigs_ID.BP_per_gene.tab"),
              row.names = FALSE,
              col.names = TRUE,
              quote = FALSE,
              sep = "\t"
...
mapped_df %>%
  dplyr::select(GOslim.BP, Term, GO.IDs, Genes) %>% 
  write.table(file =file.path(deg, "goslims_genome/GDO_sigs_ID.tab"),
          row.names = FALSE,
          col.names = TRUE,
          quote = FALSE,
          sep = "\t"
...
```{r write-flattened-genes-to-file}
goslims_per_gene_df %>%
  write.table(file =file.path(deg, "goslims_genome/GDO_sigs_ID.BP_per_gene.tab"),
              row.names = FALSE,
              col.names = TRUE,
              quote = FALSE,
              sep = "\t"
...
mapped_df %>%
  dplyr::select(GOslim.BP, Term, GO.IDs, Genes) %>% 
  write.table(file =file.path(deg, "goslims_genome/FOA_sigs_ID.tab"),
          row.names = FALSE,
          col.names = TRUE,
          quote = FALSE,
          sep = "\t"
...
```{r write-flattened-genes-to-file}
goslims_per_gene_df %>%
  write.table(file =file.path(deg, "goslims_genome/FOA_sigs_ID.BP_per_gene.tab"),
              row.names = FALSE,
              col.names = TRUE,
              quote = FALSE,
              sep = "\t"
...
mapped_df %>%
  dplyr::select(GOslim.BP, Term, GO.IDs, Genes) %>% 
  write.table(file =file.path(deg, "goslims_genome/GOA_sigs_ID.tab"),
          row.names = FALSE,
          col.names = TRUE,
          quote = FALSE,
          sep = "\t"
...
```{r write-flattened-genes-to-file}
goslims_per_gene_df %>%
  write.table(file =file.path(deg, "goslims_genome/GOA_sigs_ID.BP_per_gene.tab"),
              row.names = FALSE,
              col.names = TRUE,
              quote = FALSE,
              sep = "\t"
...
mapped_df %>%
  dplyr::select(GOslim.BP, Term, GO.IDs, Genes) %>% 
  write.table(file =file.path(deg, "goslims_genome/FOW_sigs_ID.tab"),
          row.names = FALSE,
          col.names = TRUE,
          quote = FALSE,
          sep = "\t"
...
```{r write-flattened-genes-to-file}
goslims_per_gene_df %>%
  write.table(file =file.path(deg, "goslims_genome/FOW_sigs_ID.BP_per_gene.tab"),
              row.names = FALSE,
              col.names = TRUE,
              quote = FALSE,
              sep = "\t"
...
mapped_df %>%
  dplyr::select(GOslim.BP, Term, GO.IDs, Genes) %>% 
  write.table(file =file.path(deg, "goslims_genome/GOW_sigs_ID.tab"),
          row.names = FALSE,
          col.names = TRUE,
          quote = FALSE,
          sep = "\t"
...
```{r write-flattened-genes-to-file}
goslims_per_gene_df %>%
  write.table(file =file.path(deg, "goslims_genome/GOW_sigs_ID.BP_per_gene.tab"),
              row.names = FALSE,
              col.names = TRUE,
              quote = FALSE,
              sep = "\t"
