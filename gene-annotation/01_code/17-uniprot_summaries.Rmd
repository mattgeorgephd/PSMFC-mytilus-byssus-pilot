...
top_genes <- read.csv(file.path(topgenes, "Top_50_genes/GOW_topgenes.csv"))
# Example usage
...
# Write to CSV
write.csv(GOW_topgene_summs, file.path(topgenes, "GOW_topgene_summs.csv"), row.names = FALSE)
```

### FOW
```{r}

top_genes <- read.csv(file.path(topgenes, "Top_50_genes/FOW_topgenes.csv"))
# Example usage
uniprot_ids <- c(top_genes$uniprot_accession)  # Replace with your list
email <- "sgleuch@uw.edu"  # Replace with your email
...
# Write to CSV
write.csv(topgene_summs, file.path(topgenes, "FOW_topgene_summs.csv"), row.names = FALSE)
```
### GOA
```{r}

top_genes <- read.csv(file.path(topgenes, "Top_50_genes/GOA_topgenes.csv"))
# Example usage
uniprot_ids <- c(top_genes$uniprot_accession)  # Replace with your list
email <- "sgleuch@uw.edu"  # Replace with your email
...
# Write to CSV
write.csv(topgene_summs, file.path(topgenes, "GOA_topgene_summs.csv"), row.names = FALSE)
```
### FOA
```{r}

top_genes <- read.csv(file.path(topgenes, "Top_50_genes/FOA_topgenes.csv"))
# Example usage
uniprot_ids <- c(top_genes$uniprot_accession)  # Replace with your list
email <- "sgleuch@uw.edu"  # Replace with your email
...
# Write to CSV
write.csv(topgene_summs, file.path(topgenes, "FOA_topgene_summs.csv"), row.names = FALSE)
```

### GDO
```{r}

top_genes <- read.csv(file.path(topgenes, "Top_50_genes/GDO_topgenes.csv"))
# Example usage
uniprot_ids <- c(top_genes$uniprot_accession)  # Replace with your list
email <- "sgleuch@uw.edu"  # Replace with your email
...
# Write to CSV
write.csv(topgene_summs, file.path(topgenes, "GDO_topgene_summs.csv"), row.names = FALSE)
```
### FDO
```{r}

top_genes <- read.csv(file.path(topgenes, "Top_50_genes/FDO_topgenes.csv"))
# Example usage
uniprot_ids <- c(top_genes$uniprot_accession)  # Replace with your list
email <- "sgleuch@uw.edu"  # Replace with your email
...
# Write to CSV
write.csv(topgene_summs, file.path(topgenes, "FDO_topgene_summs.csv"), row.names = FALSE)
```
