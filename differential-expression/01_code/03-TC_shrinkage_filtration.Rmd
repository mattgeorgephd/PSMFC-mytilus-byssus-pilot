...
write.table(FOA_TC_apeglm_df, file = file.path(deg, "Foot/FOA_TC_apeglm.csv"), row.names = FALSE)
...
FOA_TC_sig_genes_normal<- FOA_TC_normal_df %>%
  filter(padj < padj.cutoff)
write.table(FOA_TC_siggenes, file = file.path(deg, "Foot/FOA_TC_siggene.csv"), row.names = FALSE)
...
write.table(gene_counts_FOA_TC, file = file.path(deg, "Foot/gene_counts_FOA_TC.csv"), row.names = TRUE)


# Plot MA
#This graph has like nothing near zero for apeglm, maybe something went wrong
pdf(file= file.path(deg, "Foot/FOA_TC_MA_plots.pdf") )
...
# Write csv's with significant genes 
#ignore rowname numbers with row.names = FALSE, not included as separate column
write.table(GOA_TC_apeglm_df, file = file.path(deg, "Gill/GOA_TC.csv"), row.names = FALSE)
padj.cutoff <- 0.05 # pvalue cut-off
...
GOA_TC_sig_genes_normal<- GOA_TC_normal_df %>%
  filter(padj < padj.cutoff)
write.table(GOA_TC_sig_genes_apeglm, file = file.path(deg, "Gill/GOA_TC_siggene.csv"), row.names = FALSE)
...
write.table(gene_counts_GOA_TC,      file = file.path(deg, "Gill/gene_counts_GOA_TC.csv"),        row.names = TRUE)


# Plot MA

pdf(file= file.path(deg, "Gill/GOA_TC_MA_plots.pdf") )
par(mfrow=c(1,3), mar=c(4,4,2,1))
xlim <- c(1,1e5); ylim <- c(-3,3)
...
# Write csv's with significant genes 
#ignore rowname numbers with row.names = FALSE, not included as separate column
write.table(FOW_TC_apeglm_df, file = file.path(deg, "Foot/FOW_TC_apeglm.csv"), row.names = FALSE)
padj.cutoff <- 0.05 # pvalue cut-off
...
FOW_TC_sig_genes_normal<- FOW_TC_normal_df %>%
  filter(padj < padj.cutoff)
write.table(FOW_TC_siggenes_apeglm, file = file.path(deg, "Foot/FOW_TC_siggene.csv"), row.names = FALSE)
...
write.table(gene_counts_FOW_TC, file = file.path(deg, "Foot/gene_counts_FOW_TC.csv"), row.names = TRUE)

# Plot MA

pdf(file= file.path(deg, "Foot/FOW_TC_MA_plots.pdf") )
par(mfrow=c(1,3), mar=c(4,4,2,1))
xlim <- c(1,1e5); ylim <- c(-3,3)
...
# Write csv's with significant genes 
#ignore rowname numbers with row.names = FALSE, not included as separate column
write.table(GOW_TC_apeglm_df, file = file.path(deg, "Gill/GOW_TC_apeglm.csv"), row.names = FALSE)
padj.cutoff <- 0.05 # pvalue cut-off
...
GOW_TC_sig_genes_normal<- GOW_TC_normal_df %>%
  filter(padj < padj.cutoff)
write.table(GOW_TC_siggenes_apeglm, file = file.path(deg, "Gill/GOW_TC_siggene_apeglm.csv"), row.names = FALSE)
...
write.table(gene_counts_GOW_TC, file = file.path(deg, "Gill/gene_counts_GOW_TC.csv"), row.names = TRUE)


# Plot MA

pdf(file= file.path(deg, "Gill/GOW_TC_MA_plots.pdf") )
par(mfrow=c(1,3), mar=c(4,4,2,1))
xlim <- c(1,1e5); ylim <- c(-3,3)
...
# Write csv's with significant genes 
#ignore rowname numbers with row.names = FALSE, not included as separate column
write.table(FDO_TC_apeglm_df, file = file.path(deg, "Foot/FDO_TC_apeglm.csv"), row.names = FALSE)
padj.cutoff <- 0.05 # pvalue cut-off
...
FDO_TC_sig_genes_normal<- FDO_TC_normal_df %>%
  filter(padj < padj.cutoff)
write.table(FDO_TC_siggenes_apeglm, file = file.path(deg, "Foot/FDO_TC_siggene_apeglm.csv"), row.names = FALSE)
...
write.table(gene_counts_FDO_TC, file = file.path(deg, "Foot/gene_counts_FDO_TC.csv"), row.names = TRUE)

# Plot MA
pdf(file= file.path(deg, "Foot/FDO_TC_MA_plots.pdf") )
par(mfrow=c(1,3), mar=c(4,4,2,1))
xlim <- c(1,1e5); ylim <- c(-3,3)
...
# Write csv's with significant genes 
#ignore rowname numbers with row.names = FALSE, not included as separate column
write.table(GDO_TC_apeglm_df, file = file.path(deg, "Gill/GDO_TC_apeglm.csv"), row.names = FALSE)
padj.cutoff <- 0.05 # pvalue cut-off
...
GDO_TC_sig_genes_normal<- GDO_TC_normal_df %>%
  filter(padj < padj.cutoff)
write.table(GDO_TC_siggenes, file = file.path(deg, "Gill/GDO_TC_siggene_apeglm.csv"), row.names = FALSE)
...
write.table(gene_counts_GDO_TC, file = file.path(deg, "Gill/gene_counts_GDO_TC.csv"), row.names = TRUE)


# Plot MA

pdf(file= file.path(deg, "Gill/GDO_TC_MA_plots.pdf") )
par(mfrow=c(1,3), mar=c(4,4,2,1))
xlim <- c(1,1e5); ylim <- c(-3,3)
