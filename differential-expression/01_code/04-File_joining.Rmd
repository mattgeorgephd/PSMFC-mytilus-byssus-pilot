...
### FDO merge 
```{r}
#FDO_LC_siggene <- read.delim(file.path(deg, "Foot/FDO_LC_siggene.csv"), sep = " ", header = TRUE)
FDO_TC_siggenes_apeglm <- read.delim(file.path(deg, "Foot/FDO_TC_siggene_apeglm.csv"), sep = " ", header = TRUE)
...
write_csv(FDO_TC_siggene, file = file.path(deg, "GOterms_genome/FDO_sigs_merged.csv"))

write_csv(FDO_sigs_unID, file = file.path(deg, "GOterms_genome/FDO_sigs_unID.csv"))
write_csv(FDO_sigs_ID, file = file.path(deg, "GOterms_genome/FDO_sigs_ID.csv"))
...
### GDO merge
```{r}
#GDO_LC_siggene <- read.delim(file.path(deg, "Gill/GDO_LC_siggene.csv"), sep = " ", header = TRUE)
GDO_TC_siggene <- read.delim(file.path(deg, "Gill/GDO_TC_siggene_apeglm.csv"), sep = " ", header = TRUE)
...
#Write file of merged files
write_csv(GDO_sigs_merged, file = file.path(deg, "GOterms_genome/GDO_sigs_merged.csv"))
write_csv(GDO_sigs_unID, file = file.path(deg, "GOterms_genome/GDO_sigs_unID.csv"))
write_csv(GDO_sigs_ID, file = file.path(deg, "GOterms_genome/GDO_sigs_ID.csv"))

```

### FOA merge
```{r}
#FOA_LC_siggene <- read.delim(file.path(deg, "Foot/FOA_LC_siggene.csv"), sep = " ", header = TRUE)
FOA_TC_siggene <- read.delim(file.path(deg, "Foot/FOA_TC_siggene.csv"), sep = " ", header = TRUE)
...
#Write file of merged files
write_csv(FOA_sigs_merged, file = file.path(deg, "GOterms_genome/FOA_sigs_merged.csv"))
write_csv(FOA_sigs_unID, file = file.path(deg, "GOterms_genome/FOA_sigs_unID.csv"))
write_csv(FOA_sigs_ID, file = file.path(deg, "GOterms_genome/FOA_sigs_ID.csv"))
...
```{r}
#GOA_LC_siggene <- read.delim(file.path(deg, "Gill/GOA_LC_siggene.csv"), sep = " ", header = TRUE)
GOA_TC_siggene <- read.delim(file.path(deg, "Gill/GOA_TC_siggene.csv"), sep = " ", header = TRUE)
...
#Write file of merged files
write_csv(GOA_sigs_merged, file = file.path(deg, "GOterms_genome/GOA_sigs_merged.csv"))
write_csv(GOA_sigs_unID, file = file.path(deg, "GOterms_genome/GOA_sigs_unID.csv"))
write_csv(GOA_sigs_ID, file = file.path(deg, "GOterms_genome/GOA_sigs_ID.csv"))

```

### FOW merge
```{r}
# FOW_LC_siggene <- read.delim(file.path(deg, "Foot/FOW_LC_siggene.csv"), sep = " ", header = TRUE)
FOW_TC_siggene <- read.delim(file.path(deg, "Foot/FOW_TC_siggene.csv"), sep = " ", header = TRUE)
...
#Write file of merged files
write_csv(FOW_sigs_merged, file = file.path(deg, "GOterms_genome/FOW_sigs_merged.csv"))
write_csv(FOW_sigs_unID, file = file.path(deg, "GOterms_genome/FOW_sigs_unID.csv"))
write_csv(FOW_sigs_ID, file = file.path(deg, "GOterms_genome/FOW_sigs_ID.csv"))
...
```{r}
#GOW_LC_siggene <- read.delim(file.path(deg, "Gill/GOW_LC_siggene.csv"), sep = " ", header = TRUE)
GOW_TC_siggene <- read.delim(file.path(deg, "Gill/GOW_TC_siggene_apeglm.csv"), sep = " ", header = TRUE)
...
#Write file of merged files
write_csv(GOW_sigs_merged, file = file.path(deg, "GOterms_genome/GOW_sigs_merged.csv"))
write_csv(GOW_sigs_unID, file = file.path(deg, "GOterms_genome/GOW_sigs_unID.csv"))
write_csv(GOW_sigs_ID, file = file.path(deg, "GOterms_genome/GOW_sigs_ID.csv"))
